    ...
    <!-- Content Header (Page header) -->
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Tablero de Mandos</h1>
							<!-- <button id='btn' class="btn btn-primary" onclick="getDatosPruebas();">getDatos</button> -->
						</div><!-- /.col -->
						<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-lg-3 col-6">
							...
							<div class="small-box bg-success">
								<div class="inner">
									<!-- <h3>$560,300<sup style="font-size: 20px">%</sup></h3> -->
									<!-- <h3>$560.300<sup style="font-size: 20px"></h3> -->
									<h3>$<?php echo $dataResponse['data']['total_ventas'];?><sup style="font-size: 20px"></h3>

									<p>Total Venta del día</p>
								</div>
								<div class="icon">
						...
						<div class="col-lg-3 col-6">
							...
							<div class="small-box bg-info">
								<div class="inner">
									<h3>$<?php echo $dataResponse['data']['total_venta_proyectada'];?></h3>
									<p>Total Venta proyectada</p>
								</div>
								<div class="icon">
						...
						<div class="col-lg-3 col-6">
							...
							<div class="small-box bg-warning">
								<div class="inner">
									<h3><?php echo $dataResponse['data']['total_ordenes'];?></h3>
									<p>Orden de pedidos en curso</p>
								</div>
								<div class="icon">
						...
						<div class="col-lg-3 col-6">
							...
							<div class="small-box bg-danger">
								<div class="inner">
									<h3><?php echo $dataResponse['data']['total_mesas_disponibles'];?></h3>
									<p>Mesa(s) Disponible(s)</p>
								</div>
								<div class="icon">
