...
<head>
	...
	<title>La Piazza Di Fiori | Dashboard</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<div class="wrapper">
		...
		<div class="preloader flex-column justify-content-center align-items-center">
			...
			<img class="animation__shake" src="<?= base_url();?>/public/dist/img/PiazzaDifioriLogo.jpg" alt="Piazza Di Fiori" height="60" width="60">
		</div>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index3.html" class="brand-link">
				...
				<img src="<?= base_url();?>/public/dist/img/PiazzaDifioriLogo.jpg" alt="Piazza Di Fiori" class="brand-image img-circle elevation-3" style="opacity: .8">
				<span class="brand-text font-weight-light">Piazza Di Fiori</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<!-- <div class="image"> -->
						...
						<!-- <img src="<?= base_url();?>/public/dist/img/cajera.jpg" class="img-circle elevation-2" alt="User Image"> -->
					<!-- </div> -->
					<div class="info">
						<!-- <a href="#" class="d-block">Alexander Pierce</a> -->
						<a href="#" class="d-block">Maria Teresa - Cajera</a>
					</div>
				</div>
						...
						<li class="nav-item menu-open">
							...
							<li class="nav-item">									
								...
								<ul class="nav nav-treeview">
									<li class="nav-item">
										<a href="Dashboard/prueba" class="nav-link">
							...
							<li class="nav-item">
								...
								<ul class="nav nav-treeview">
									...
									<li class="nav-item">
										<a href="Dashboard/prueba" class="nav-link">
											<i class="far fa-circle nav-icon"></i>
											<p>Comparativo Ventas</p>
										</a>
									</li>
									<li class="nav-item">
										<a href="Dashboard/prueba" class="nav-link">
											<i class="far fa-circle nav-icon"></i>
											<p>Rancking Productos</p>
										</a>
									</li>
									...
									<li class="nav-item">
										<a href="Dashboard/prueba" class="nav-link">
											<i class="far fa-circle nav-icon"></i>
											<p>Comparativo Producto</p>
										</a>
									</li>

								</ul>
							</li>
							<!-- ///*** FIN MENUINFORME VENTAS /// -->
							...
							<!-- <ul class="nav nav-treeview">
								<li class="nav-item"> -->
									...
									<!-- <a href="Dashboard/prueba" class="nav-link active">
										<i class="far fa-circle nav-icon"></i>
										<p>Dashboard v1</p>
									</a>
								</li>
		...
		<footer class="main-footer">
			<!-- <strong>Copyright &copy; 2022 <a href="https://www.psprog.cl">www.psprog.cl</a>.</strong> -->
			<strong>Copyright &copy; 2022 psprog@gmail.com</strong>
			All rights reserved.
	...
	<script>
		...
		function getDatosPruebas(){

			let usuario = 'rfierro';
			let clave = '21232f297a57a5a743894a0e4a801fc3';
			...
			$.ajax({
					...
					url: '<?= base_url();?>/Dashboard/getDataUsuario',
					...
					success:function(response){ //los resultados vuelven en response (request.responseText);
						...
						//cargarTabla(response.responseText); 
